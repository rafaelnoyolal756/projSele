...
namespace SeleniumTests
{
    ...
    public class deleteClause
    {
        ...
        [Test]
        public void TheDeleteClauseTest()
        {
            ...
            try
            {
                Assert.IsTrue(IsElementPresent(By.LinkText("Test Agreement Clause")));
                Console.WriteLine("Test Agreement Clause - FOUND");
            }
            catch (AssertionException e)
            {
                verificationErrors.Append(e.Message);
            }
            driver.FindElement(By.LinkText("Test Agreement Clause")).Click();
            Thread.Sleep(4000);
            ...
            try
            {
                ...
                Console.WriteLine("Original Clause deleted successfully.");
            }
            catch (AssertionException e)
            {
                verificationErrors.Append(e.Message);
